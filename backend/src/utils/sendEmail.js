...
//transporterInfo gives form information while mailInof gives to info
let transporterInfo = {
  // host: emailHost,
  host: "smtp.gmail.com",
  ...
  auth: {
    ...
    user: email,
    pass: password,
    // to send email from server first you have to =>
    //use 2-step verification and generate app password
    //instead of using your password use app password of gmail
    //for this go to the => manage your account => security setting and=>enable 2-step verifiction =>crete app paassword (select other option)
  },
};
